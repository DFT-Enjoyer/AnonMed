...
_DEFAULT_CASES: tuple[PreprocessingCase, ...] = (
    ...
    PreprocessingCase("phrase_dobry_den_leading", "добрый день номер один", "номер один"),
    PreprocessingCase("phrase_dobry_den_inner", "номер добрый день один", "номер один"),
    PreprocessingCase("phrase_dobry_den_punctuated", "номер, добрый день, один", "номер один"),
    PreprocessingCase("phrase_dobry_den_titlecase", "Добрый день номер один", "номер один"),
