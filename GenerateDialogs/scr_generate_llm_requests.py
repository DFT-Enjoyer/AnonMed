...
8. Диалоги должны быть маскимально естественными, обязательно с междометиями в естественных для этого местах. Все должно быть как в реальном диалоге. Не должно быть пунктуации. Пиши одним потоком, как в примере:
{few_shot_example}
...
Твои действия:
Напиши диалог на ~{target_word_count} слов. Внутри реплик не ставь знаки препинания, текст идёт слитно. Каждая реплика начинается с новой строки, с тире и пробела.
"""
